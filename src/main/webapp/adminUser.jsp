        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-10">
                <div class="card p-4">
                    ...
                    <h2 class="text-center mt-5 mb-4">Orders Review</h2>

                    <div class="table-responsive">
                        <table class="table table-bordered">
                            <thead class="thead-dark">
                                <tr>
                                    <th>Order_ID</th> <th>User_ID</th> <th>Email</th> <th>Phone Number</th>
                                    <th>Total Amount</th> <th>Ordered At</th> <th>Order Status</th> <th>Action</th>
                                </tr>
                            </thead>
                            <tbody>
